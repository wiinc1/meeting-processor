...
using Crawl4AI after manual login with Selenium.
"""
...
async def get_real_latest_transcript_crawl4ai():
    """Get the REAL latest meeting transcript using Crawl4AI after Selenium login."""
    try:
        ...
        logger.info("=" * 70)
        logger.info("Using Selenium for login + Crawl4AI for scraping (best of both worlds!)")
        
        # Step 1: Use Selenium for login (more reliable for authentication)
        ...
        # Step 2: Use Crawl4AI for fast scraping (after login)
        logger.info("🚀 Step 2: Using Crawl4AI for fast transcript extraction...")
...
async def main():
    ...
    print("🎯 REAL Otter.ai Latest Meeting Transcript Extractor")
    print("=" * 60)
    print("This script will:")
    print("1. Use Selenium for reliable authentication")
    print("2. Use Crawl4AI for fast transcript extraction")
    ...
    result = await get_real_latest_transcript_crawl4ai()
