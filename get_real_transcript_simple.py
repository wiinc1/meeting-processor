...
using a simple approach with manual navigation.
"""
...
async def get_real_latest_transcript_simple():
    """Get the REAL latest meeting transcript using a simple approach."""
    try:
        ...
        logger.info("=" * 70)
        logger.info("Using Selenium for authentication and navigation")
        ...
        # Manual navigation to meetings
        logger.info("📋 Please navigate to your meetings list in the browser")
        logger.info("💡 You can go to: https://otter.ai/home or click on 'My Conversations'")
        logger.info("⏳ The script will wait for you to navigate to the meetings page...")
        
        # Wait for user to navigate
        input("Press Enter when you're on the meetings page...")
        
        # Try to get meetings
        logger.info("📋 Attempting to get your recent meetings...")
        meetings = await scraper.get_all_meetings()
        
        if not meetings:
            logger.error("❌ No meetings found. Please check that you're on the meetings page.")
            return None
...
async def main():
    ...
    print("🎯 REAL Otter.ai Latest Meeting Transcript Extractor (Simple)")
    print("=" * 70)
    print("This script will:")
    print("1. Open a browser window for you to log in to Otter.ai")
    print("2. Wait for you to navigate to your meetings page")
    ...
    result = await get_real_latest_transcript_simple()
