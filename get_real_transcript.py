...
using Crawl4AI with manual authentication.
"""
...
async def get_real_latest_transcript():
    """Get the REAL latest meeting transcript from your Otter.ai account."""
    try:
        ...
        # Initialize Crawl4AI scraper in non-headless mode for manual authentication
...
async def main():
    ...
    result = await get_real_latest_transcript()
